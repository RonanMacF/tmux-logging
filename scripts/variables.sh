...
# Logging options
default_logging_path="$HOME/dotfiles/tmux/logging/%Y-%m-%d"
...
default_screen_capture_path="$HOME/dotfiles/tmux/logging/%Y-%m-%d"
...
default_save_complete_history_path="$HOME/dotfiles/tmux/logging/%Y-%m-%d"
